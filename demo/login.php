...
header("Location: $IDP_URL/auth?client_id=$CLIENT_ID&response_type=$RESPONSE_TYPE_SIGNIN&redirect_uri=$REDIRECT_URI&scope=$SCOPE_LOGIN&state=$state&nonce=spardeco");

...
$params = array(
	...
	"address" => "",
	"updated_at" => $today[0]//['mon'].'/'.$today['mday'].'/'.$today['year'],
);
...
<tr><td>Enabled:</td><td><input type='text' name='enabled'value='1'/></td></tr>
...
<tr><td>Email Verified:</td><td><input type='text' name='email_verified' value='0'/> </td></tr>
...
<tr><td>Phone Number Verified:</td><td><input type='text' name='phone_number_verified'value='0'/> </td></tr>
